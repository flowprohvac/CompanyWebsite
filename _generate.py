      ...
      <ul>
        ...
        <li class="has-dropdown">
          ...
          <ul class="dropdown">
            ...
            <li><a href="/services/emergency-hvac.html">24/7 Emergency Service</a></li>
          </ul>
        </li>
        <li class="has-dropdown">
    ...
    <div class="grid">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="/services/indoor-air-quality.html">Indoor Air Quality</a></li>
          <li><a href="/services/commercial-hvac.html">Commercial HVAC</a></li>
          <li><a href="/services/emergency-hvac.html">24/7 Emergency</a></li>
        </ul>
      </div>
      <div>
        <h4>Service Areas</h4>
...
SERVICES = [
    ...
    },
    {
        ...
        "h1": "AC Installation in Corona & the Inland Empire",
        "title": "AC Installation in Corona, CA | FlowProHVAC",
        "desc": "New AC installation in Corona, CA. Free in-home estimate, honest options, properly sized systems. 30+ years experience. Licensed & insured. Call (818) 625-4400.",
        "subtitle": "New high-efficiency systems sized correctly for your home — with a free, no-pressure estimate.",
        "intro": "A new AC system is a big purchase. We've been installing them in Inland Empire homes for over 30 years, and we believe the job is done right when the system is properly sized, properly installed, and fairly priced — and when you actually understand what you bought.",
        "sections": [
            ("What's included in a new AC install", [
            ...
            ("Brands we install", [
                "Carrier, Trane, Lennox, Rheem, Goodman, American Standard, Daikin, and more",
                "We are not locked into one brand — we recommend what fits your home and budget",
            ]),
            ("Why right-sizing matters more than the brand", [
        ...
        "faqs": [
            ("How much does a new AC system cost in Corona?",
             "A typical single-family home in Corona will land in the $7,000 – $14,000 range for a complete replacement, depending on size, SEER rating, and ductwork condition. We give a detailed, itemized written estimate."),
    ...
    },
    {
        ...
        "title": "Furnace Repair in Corona, CA | FlowProHVAC",
        "desc": "Furnace not heating, short cycling, or making noise? Honest furnace repair in Corona & the Inland Empire. 24/7 emergency service. Call (818) 625-4400.",
        "subtitle": "Diagnosed correctly, repaired safely. Gas furnaces, heat pumps, and electric heat — we work on all of it.",
        "intro": "Heating problems get worse the longer they're ignored, and a few of them — like cracked heat exchangers — can be dangerous. Our techs diagnose the actual problem, explain what's going on, and get your heat back on safely.",
        "sections": [
        ...
        "faqs": [
            ("Do you offer emergency furnace repair?",
             "Yes — 24/7. If your heat is out on a cold night, call us at (818) 625-4400 anytime."),
            ("How much does furnace repair cost?",
             "Most furnace repairs land in the $200 – $600 range. We give a written quote before any work."),
            ("My furnace is old — should I repair or replace?",
             "If your furnace is over 15 years old and the repair is significant, replacement may be more economical. We'll give you both numbers and let you decide."),
        ],
    },
    {
        "slug": "furnace-installation",
        "h1": "Furnace Installation in Corona, CA",
        "title": "Furnace Installation in Corona, CA | FlowProHVAC",
        "desc": "Energy-efficient furnace installation in Corona and the Inland Empire. Free estimate. Licensed & insured. 30+ years experience. Call (818) 625-4400.",
        "subtitle": "Properly sized, properly installed, and warrantied — with a free in-home estimate.",
        "intro": "A new furnace should last 15 – 20 years if it's installed right. Sizing, gas pressure, venting, and combustion air all need to be correct on day one. We've been doing this for over three decades — and we treat every install like our own home.",
        "sections": [
            ...
            ("Single-stage, two-stage, or modulating?", [
                ...
                "Modulating furnaces are the top tier — most efficient and most comfortable, but the highest upfront cost.",
                "We'll walk you through what makes sense for your house and budget.",
            ]),
        ],
        "faqs": [
            ("How much does a new furnace cost in Corona?",
             "Most residential furnace installations in Corona land in the $4,500 – $9,000 range, depending on size, efficiency, and complexity. Itemized estimate provided."),
    ...
    },
    {
        ...
        "title": "Mini-Split Installation in Corona, CA | FlowProHVAC",
        "desc": "Ductless mini-split installation in Corona and the Inland Empire — for ADUs, garages, additions, and homes without ductwork. Call (818) 625-4400.",
        "subtitle": "Heating and cooling for rooms your central system can't reach — installed cleanly and properly.",
        ...
        "faqs": [
            ("How much does a mini-split cost installed?",
             "A single-zone mini-split installation typically runs $3,500 – $6,500 depending on capacity and complexity. Multi-zone systems cost more."),
    ...
    },
    {
        ...
        "title": "Commercial HVAC in Corona, CA | FlowProHVAC",
        "desc": "Commercial HVAC service, repair, and installation in Corona and throughout California. Offices, retail, light industrial. 30+ years experience. Call (818) 625-4400.",
    ...
    {
        "slug": "emergency-hvac",
        "h1": "24/7 Emergency HVAC Service in Corona, CA",
        "title": "24/7 Emergency HVAC Repair in Corona, CA | FlowProHVAC",
        "desc": "AC or heat out? 24/7 emergency HVAC service in Corona and the Inland Empire. We answer the phone and respond fast. Call (818) 625-4400.",
        "subtitle": "We answer the phone. We respond fast. No heat or no cooling shouldn't have to wait.",
        "intro": "An HVAC failure in a heatwave or a cold snap isn't an inconvenience — it can be a health and safety issue, especially with seniors, young kids, or anyone with health conditions. We provide true 24/7 emergency HVAC service throughout Corona and the surrounding Inland Empire.",
        "sections": [
            ("When to call us right away", [
                "No cooling during high heat",
                "No heat in cold weather",
                "Burning smell from the system",
                "Suspected gas leak (also call your gas company)",
                "Carbon monoxide detector going off",
                "Water leaking heavily from the system",
                "Frozen pipes or coils",
                "System is making loud unusual noises",
            ]),
            ("What to expect when you call after hours", [
                "A real person answers the phone — usually the technician on call",
                "We confirm the issue and give you an ETA",
                "We arrive with the truck stocked for common emergency repairs",
                "Upfront pricing — we tell you the cost before we begin",
            ]),
        ],
        "faqs": [
            ("Do you charge extra for emergency service?",
             "After-hours and weekend service calls do carry a higher trip rate than a scheduled weekday visit. We tell you the rate upfront before we dispatch."),
            ("How fast can you get here?",
             "Response times depend on where you are and what's happening in our service area at the time. We give you a realistic ETA when you call — not a promise we can't keep."),
        ],
    },
]
...
def render_city_page(c):
    ...
    title = f"HVAC Services in {c['name']}, CA | FlowProHVAC"
    desc = (f"Family-owned HVAC company serving {c['name']}, CA since 1994. AC repair, "
            f"heating, mini-splits, and 24/7 emergency service. Licensed & insured. "
            f"Call (818) 625-4400.")
...
<section class="section">
  <div class="container-sm prose">
    ...
    <ul>
      ...
      <li>Licensed, bonded, and insured in California</li>
      ...
      <li>24/7 emergency service when you need it</li>
    </ul>
