...
<head>
  ...
  }})(window,document,'script','dataLayer','GTM-M69CXSMK');</script>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=AW-18194038866"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){{dataLayer.push(arguments);}}
    gtag('js', new Date());
    gtag('config', 'AW-18194038866');
    gtag('config', 'AW-18194038866/XhsSCNfM9cocENKAzOND', {{
      'phone_conversion_number': '(818) 625-4400'
    }});
  </script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M69CXSMK"
